...
ILUVATAR_CONTROLLER__logging__directory=$ret ILUVATAR_WORKER__logging__directory=$ret $ILU_HOME/target/release/iluvatar_load_gen trace --out-folder $results_dir --port $PORT --host $host --target 'controller' --setup 'simulation' \
