...
use iluvatar_worker_library::{rpc::{RegisterRequest, LanguageRuntime}, services::{invocation::InvocationResult, containers::structs::ContainerTimeFormatter, resources::{cpu::CpuResourceTracker, gpu::GpuResourceTracker}}};
...
pub async fn full_sim_invoker(config_pth: Option<String>, overrides: Option<Vec<(String,String)>>, log: Option<bool>) -> (Option<impl Drop>, WorkerConfig, Arc<ContainerManager>, Arc<dyn Invoker>, Arc<RegistrationService>, Arc<CharacteristicsMap>, Arc<GpuResourceTracker>, Arc<CpuResourceTracker>) {
