...
use iluvatar_library::{transaction::TransactionId, api_register::register_worker, types::{Compute, Isolation}, nproc};
...
pub fn register_rpc_to_controller(server_config: Arc<Configuration>, tid: TransactionId) {
  let _ = tokio::spawn(async move {
      ...
      &server_config.address, server_config.port, server_config.container_resources.memory_mb, cores,
