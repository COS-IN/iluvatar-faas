...
#
# # CPU thread settings only matter for CPU mode
# if DEVICE == "cpu":
...
#     """
#     Pre-processes the image to allow the image to be fed into the model.
#     """
...
#                 "cold": was_cold,
#                 "Device": DEVICE,
#                 "Torch Threads": torch.get_num_threads() if DEVICE == "cpu" else "N/A on GPU",
#                 "Torch Interop Threads": torch.get_num_interop_threads() if DEVICE == "cpu" else "N/A on GPU",
